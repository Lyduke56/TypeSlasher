...
func setup_room_connections():
	...
	room_a.set_connected_room("top", room_d)
	room_a.set_connected_room("left", starting)

	room_b.set_connected_room("top", boss)
	room_b.set_connected_room("left", room_e)
	room_b.set_connected_room("right", room_d)
	room_b.set_connected_room("bottom", starting)

	room_c.set_connected_room("right", starting)

	room_d.set_connected_room("left", room_b)
	room_d.set_connected_room("bottom", room_a)
