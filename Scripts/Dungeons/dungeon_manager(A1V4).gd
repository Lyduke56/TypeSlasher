...
func setup_room_connections():
	...
	room_a.set_connected_room("top", room_b)
	room_a.set_connected_room("bottom", room_c)

	room_b.set_connected_room("bottom", room_a)
	room_b.set_connected_room("right", portal)

	room_c.set_connected_room("top", room_a)

	room_d.set_connected_room("top", starting)

	portal.set_connected_room("left", room_b)
