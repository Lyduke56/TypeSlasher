...
func setup_room_connections():
	...
	starting.set_connected_room("top", room_c)

	room_a.set_connected_room("left", starting)
	room_a.set_connected_room("bottom", room_b)

	room_b.set_connected_room("top", room_a)
	room_b.set_connected_room("right", idle)

	room_c.set_connected_room("right", healing)
	room_c.set_connected_room("bottom", starting)

	portal.set_connected_room("bottom", idle)

	idle.set_connected_room("left", room_b)
	idle.set_connected_room("top", portal)

	healing.set_connected_room("left", room_c)
