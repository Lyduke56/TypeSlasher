...
func setup_room_connections():
	...
	var room_c = get_node("../RoomC - Hard")
	var room_d = get_node("../RoomD - Small")
	var healing = get_node("../HealingRoom")
	var portal = get_node("../PortalRoom")

	starting.set_connected_room("right", room_d)
	starting.set_connected_room("left", healing)
	...
	healing.set_connected_room("right", starting)

	room_d.set_connected_room("left", starting)
	room_d.set_connected_room("top", portal)

	portal.set_connected_room("bottom", room_d)
