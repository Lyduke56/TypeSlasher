...
func setup_room_connections():
	...
	var room_e = get_node("../RoomE - Small")
	var room_f = get_node("../RoomF - Medium")
	var portal = get_node("../PortalRoom")

	starting.set_connected_room("top", room_d)
	starting.set_connected_room("bottom", room_a)

	room_a.set_connected_room("top", starting)
	room_a.set_connected_room("right", room_b)

	room_b.set_connected_room("left", room_a)
	room_b.set_connected_room("top", room_c)

	room_c.set_connected_room("bottom", room_b)
	room_c.set_connected_room("top", portal)

	room_d.set_connected_room("bottom", starting)
	room_d.set_connected_room("left", room_e)

	room_e.set_connected_room("bottom", room_f)
	room_e.set_connected_room("right", room_d)

	room_f.set_connected_room("top", room_e)

	portal.set_connected_room("bottom", room_c)
